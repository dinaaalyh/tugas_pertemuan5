...
class _EditState extends State<Edit> {
  ...
  void editData(){
    var url = Uri.parse('http://192.168.56.1/restapi5/update.php'); //update api calling
...
@override
void initState() {
  name = TextEditingController(text: widget.list[widget.index]['name']); //setting up the
